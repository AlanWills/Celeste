...
{
    [Serializable]
    public class UnsignedVector3 : ICustomSerialization, ICustomDeserialization
    {
        ...
        public UnsignedVector3() : this(0, 0, 0)
        {
            // Needed for deserialization so don't delete
        }

        public UnsignedVector3(float x, float y, float z)
        {
            X = x;
            Y = y;
            Z = z;
