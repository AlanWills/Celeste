...
#pragma region Find Component With Predicate Tests
  ...
  //------------------------------------------------------------------------------------------------
  TEST_METHOD(GameObject_FindComponentWithPredicate_WithMatchingManagedComponent_ReturnsCorrectPtr)
  {
    GameObject gameObject;
    observer_ptr<MockManagedComponent> component = gameObject.addComponent<MockManagedComponent>();
    ...
    Assert::IsTrue(gameObject.findComponent<MockManagedComponent>(predicate) == component);
  }

  //------------------------------------------------------------------------------------------------
  TEST_METHOD(GameObject_FindComponentWithPredicate_WithNoMatchingManagedComponent_ReturnsNullptr)
  {
    GameObject gameObject;
    ...
    Assert::IsNull(gameObject.findComponent<MockManagedComponent>(predicate));
  }
  ...
  TEST_METHOD(GameObject_FindComponentWithPredicate_WithNoMatchingScriptComponent_ReturnsNullptr)
  {
    ...
    Assert::IsNull(gameObject.findComponent<MockUnmanagedComponent>(predicate));
  }
...
#pragma region Find Const Component With Predicate Tests
  ...
  //------------------------------------------------------------------------------------------------
  TEST_METHOD(GameObject_FindConstComponentWithPredicate_WithMatchingManagedComponent_ReturnsCorrectPtr)
  {
    GameObject gameObject;
    observer_ptr<MockManagedComponent> component = gameObject.addComponent<MockManagedComponent>();
    ...
    const MockManagedComponent* handle = static_cast<const GameObject*>(&gameObject)->findComponent<MockManagedComponent>(predicate);

    Assert::IsTrue(handle == component);
  }

  //------------------------------------------------------------------------------------------------
  TEST_METHOD(GameObject_FindConstComponentWithPredicate_WithNoMatchingManagedComponent_ReturnsNullptr)
  {
    GameObject gameObject;

    const MockManagedComponent* mockComponent = static_cast<const GameObject*>(&gameObject)->findComponent<MockManagedComponent>();
    ...
    const MockManagedComponent* result2 = static_cast<const GameObject*>(&gameObject)->findComponent<MockManagedComponent>(predicate);
  ...
  TEST_METHOD(GameObject_FindConstComponentWithPredicate_WithMatchingScriptComponent_ReturnsCorrectPtr)
  {
    ...
    const MockUnmanagedComponent* handle = static_cast<const GameObject*>(&gameObject)->findComponent<MockUnmanagedComponent>(predicate);
  ...
  TEST_METHOD(GameObject_FindConstComponentWithPredicate_WithNoMatchingScriptComponent_ReturnsNullptr)
  {
    ...
    const MockUnmanagedComponent* result2 = static_cast<const GameObject*>(&gameObject)->findComponent<MockUnmanagedComponent>(predicate);
