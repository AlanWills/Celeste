...
#pragma region Initialize Tests
  ...
  {
    Assert::IsFalse(LuaState::instance()[EventTriggerer::type_name()].valid());

    Celeste::Lua::Events::EventTriggererScriptCommands::initialize();

    Assert::IsTrue(LuaState::instance()[EventTriggerer::type_name()].valid());
  }
  ...
  TEST_METHOD(EventTriggererScriptCommands_Initialize_Adds_getTriggerDelay_ToEventTriggerTable)
  {
    ...
    Assert::IsTrue(LuaState::instance()[EventTriggerer::type_name()]["getTriggerDelay"].valid());
  }
  ...
  TEST_METHOD(EventTriggererScriptCommands_Initialize_Adds_setTriggerDelay_ToEventTriggerTable)
  {
    ...
    Assert::IsTrue(LuaState::instance()[EventTriggerer::type_name()]["setTriggerDelay"].valid());
  }
  ...
  TEST_METHOD(EventTriggererScriptCommands_Initialize_Adds_getTriggerKey_ToEventTriggerTable)
  {
    ...
    Assert::IsTrue(LuaState::instance()[EventTriggerer::type_name()]["getTriggerKey"].valid());
  }
  ...
  TEST_METHOD(EventTriggererScriptCommands_Initialize_Adds_setTriggerKey_ToEventTriggerTable)
  {
    ...
    Assert::IsTrue(LuaState::instance()[EventTriggerer::type_name()]["setTriggerKey"].valid());
  }
  ...
  TEST_METHOD(EventTriggererScriptCommands_Initialize_Adds_getTriggerMode_ToEventTriggerTable)
  {
    ...
    Assert::IsTrue(LuaState::instance()[EventTriggerer::type_name()]["getTriggerMode"].valid());
  }
  ...
  TEST_METHOD(EventTriggererScriptCommands_Initialize_Adds_setTriggerMode_ToEventTriggerTable)
  {
    ...
    Assert::IsTrue(LuaState::instance()[EventTriggerer::type_name()]["setTriggerMode"].valid());
  }
  ...
  TEST_METHOD(EventTriggererScriptCommands_Initialize_Adds_subscribeOnEventTriggered_ToEventTriggerTable)
  {
    ...
    Assert::IsTrue(LuaState::instance()[EventTriggerer::type_name()]["subscribeOnEventTriggeredCallback"].valid());
  }
  ...
  TEST_METHOD(EventTriggererScriptCommands_Initialize_Adds_as_ToEventTriggerTable)
  {
    ...
    Assert::IsTrue(LuaState::instance()[EventTriggerer::type_name()]["as"].valid());
  }
...
#pragma region Get Trigger Delay Tests
  ...
  TEST_METHOD(EventTriggererScriptCommands_getTriggerDelay_ReturnsCorrectValue)
  {
    ...
    Celeste::Lua::Events::EventTriggererScriptCommands::initialize();
    auto result = LuaState::instance()[EventTriggerer::type_name()]["getTriggerDelay"].get<sol::protected_function>().call(*eventTriggerer);
...
#pragma region Set Trigger Delay Tests
  ...
  TEST_METHOD(EventTriggererScriptCommands_setTriggerDelay_UpdatesTriggerDelayToCorrectValue)
  {
    ...
    Celeste::Lua::Events::EventTriggererScriptCommands::initialize();
    auto result = LuaState::instance()[EventTriggerer::type_name()]["setTriggerDelay"].get<sol::protected_function>().call(*eventTriggerer, 5);
...
#pragma region Get Trigger Key Tests
  ...
  TEST_METHOD(EventTriggererScriptCommands_getTriggerKey_ReturnsCorrectValue)
  {
    ...
    Celeste::Lua::Events::EventTriggererScriptCommands::initialize();
    auto result = LuaState::instance()[EventTriggerer::type_name()]["getTriggerKey"].get<sol::protected_function>().call(*eventTriggerer);
...
#pragma region Set Trigger Key Tests
  ...
  TEST_METHOD(EventTriggererScriptCommands_setTriggerKey_InputtingInvalidValue_DoesNotChangeCurrentTriggerKey)
  {
    ...
    Celeste::Lua::Events::EventTriggererScriptCommands::initialize();
    auto result = LuaState::instance()[EventTriggerer::type_name()]["setTriggerKey"].get<sol::protected_function>().call(*eventTriggerer, "WubbaLubbaDubDub");
  ...
  TEST_METHOD(EventTriggererScriptCommands_setTriggerKey_InputtingValidValue_UpdatesTriggerKeyToCorrectValue)
  {
    ...
    Celeste::Lua::Events::EventTriggererScriptCommands::initialize();
    auto result = LuaState::instance()[EventTriggerer::type_name()]["setTriggerKey"].get<sol::protected_function>().call(*eventTriggerer, "A");
...
#pragma region Get Trigger Mode Tests
  ...
  TEST_METHOD(EventTriggererScriptCommands_getTriggerMode_InputtingValidValue_ReturnsCorrectValue)
  {
    ...
    Celeste::Lua::Events::EventTriggererScriptCommands::initialize();
    auto result = LuaState::instance()[EventTriggerer::type_name()]["getTriggerMode"].get<sol::protected_function>().call(*eventTriggerer);
...
#pragma region Set Trigger Mode Tests
  ...
  TEST_METHOD(EventTriggererScriptCommands_setTriggerMode_InputtingInvalidValue_DoesNotChangeCurrentTriggerMode)
  {
    ...
    Celeste::Lua::Events::EventTriggererScriptCommands::initialize();
    auto result = LuaState::instance()[EventTriggerer::type_name()]["setTriggerMode"].get<sol::protected_function>().call(*eventTriggerer, "WubbaLubbaDubDub");
  ...
  TEST_METHOD(EventTriggererScriptCommands_setTriggerMode_UpdatesTriggerModeToCorrectValue)
  {
    ...
    Celeste::Lua::Events::EventTriggererScriptCommands::initialize();
    auto result = LuaState::instance()[EventTriggerer::type_name()]["setTriggerMode"].get<sol::protected_function>().call(*eventTriggerer, "Unlimited");
...
#pragma region Subscribe On Event Triggered Callback Tests
  ...
  TEST_METHOD(EventTriggererScriptCommands_subscribeOnEventTriggered_SubscribesToEvent)
  {
    ...
    Celeste::Lua::Events::EventTriggererScriptCommands::initialize();
    auto result = LuaState::instance()[EventTriggerer::type_name()]["subscribeOnEventTriggeredCallback"].
